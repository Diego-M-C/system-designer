...
> **Source:** [https://anthropic.skilljar.com/claude-with-the-anthropic-api](https://anthropic.skilljar.com/claude-with-the-anthropic-api)
> **Category:** core-api | **Difficulty:** intermediate | **Domain:** Core API Development
> **Tags:** api, sdk, python, prompt-engineering, tool-use, rag, mcp, agents
...
| Total Lessons | 85 |
| Sections | 13 |
| JW Player Transcripts | 75 |
| YouTube Transcripts | 0 |
| Modular Text Lessons | 1 |
| Quiz Assessments | 8 |
| JW Transcript Chars | 483,045 |
| YouTube Transcript Chars | 0 |
| Modular Text Chars | 1,107 |
| **Total Content** | **484,152** |

## Curriculum Structure

- **Introduction** (1 lessons)
- **Anthropic overview** (1 lessons)
- **Accessing Claude with the API** (13 lessons)
- **Prompt evaluation** (8 lessons)
- **Prompt engineering techniques** (7 lessons)
- **Tool use with Claude** (13 lessons)
- **RAG and Agentic Search** (7 lessons)
- **Features of Claude** (9 lessons)
- **Model Context Protocol** (12 lessons)
- **Anthropic apps - Claude Code and computer use** (4 lessons)
...
*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287818](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287818)

**Video:** 01 - 001 - Welcome to the Course.mp4 | **Duration:** 2m 14s | **Platform:** jwplayer | **Captions:** English, French, German, Japanese, Korean, Portuguese, Spanish
...
*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287722](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287722)
...
*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287726](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287726)

**Video:** 03 - 001 - Accessing the API.mp4 | **Duration:** 5m 18s | **Platform:** jwplayer | **Captions:** English, French, German, Japanese, Korean, Portuguese, Spanish
...
#### Lesson 4: Getting an API key

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/296766](https://anthropic.skilljar.com/claude-with-the-anthropic-api/296766)
...
*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287725](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287725)

**Video:** 03 - 003 - Making a Request.mp4 | **Duration:** 6m 2s | **Platform:** jwplayer | **Captions:** English, French, German, Japanese, Korean, Portuguese, Spanish
...
*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287735](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287735)
...
*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287727](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287727)
...
*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287733](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287733)
...
*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287724](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287724)
...
*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287728](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287728)
...
*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/297284](https://anthropic.skilljar.com/claude-with-the-anthropic-api/297284)

---

#### Lesson 12: Response streaming

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287734](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287734)
...
#### Lesson 13: Structured data

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287732](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287732)
...
#### Lesson 14: Structured data exercise

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287729](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287729)
...
#### Lesson 15: Quiz on accessing Claude with the API

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/289117](https://anthropic.skilljar.com/claude-with-the-anthropic-api/289117)
...
- **[CORRECT]** API key, model name, messages, and max tokens
...
- **[CORRECT]** Claude doesn't remember previous messages
...
- **[CORRECT]** Breaks it into smaller chunks called tokens
...
- **[CORRECT]** Enabling response streaming
...
- **[CORRECT]** On your server that users can't access
...
- **[CORRECT]** A system prompt explaining the tutor role
...
- **[CORRECT]** Low temperature (near 0.0)
...
- **[CORRECT]** Combine prefilled messages and stop sequences
...
#### Lesson 16: Prompt evaluation

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287731](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287731)
...
#### Lesson 17: A typical eval workflow

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287736](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287736)
...
#### Lesson 18: Generating test datasets

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287739](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287739)
...
#### Lesson 19: Running the eval

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287743](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287743)
...
#### Lesson 20: Model based grading

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287742](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287742)
...
#### Lesson 21: Code based grading

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287737](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287737)
...
#### Lesson 22: Exercise on prompt evals

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287738](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287738)

**Video:** 04 - 007 - Exercise on Prompt Evals.mp4 | **Duration:** 4m 44s | **Platform:** jwplayer | **Captions:** English, French, German, Japanese, Korean, Portuguese, Spanish
...
#### Lesson 23: Quiz on prompt evaluation

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/289118](https://anthropic.skilljar.com/claude-with-the-anthropic-api/289118)
...
- **[CORRECT]** Users will provide unexpected inputs that break it
...
- **[CORRECT]** A faster model like Haiku
...
- **[CORRECT]** Feed the responses through a grader
...
- **[CORRECT]** Prompt evaluation methods
...
#### Lesson 24: Prompt engineering

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287745](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287745)
...
#### Lesson 25: Being clear and direct

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287744](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287744)
...
#### Lesson 26: Being specific

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287740](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287740)
...
#### Lesson 27: Structure with XML tags

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287741](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287741)
...
#### Lesson 28: Providing examples

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287746](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287746)
...
#### Lesson 29: Exercise on prompting

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287748](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287748)

**Video:** 05 - 006 - Exercise on Prompting.mp4 | **Duration:** 5m 22s | **Platform:** jwplayer | **Captions:** English, French, German, Japanese, Korean, Portuguese, Spanish
...
#### Lesson 30: Quiz on prompt engineering techniques

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/289121](https://anthropic.skilljar.com/claude-with-the-anthropic-api/289121)

**Assessment (5 questions):**

**Q1:** You want Claude to create a workout plan. Which opening line works better?

- **[CORRECT]** "Create a 30-minute workout plan for beginners"
...
- **[CORRECT]** Provide examples showing sarcastic posts labeled as negative
...
- **[CORRECT]** Improving a prompt to get more reliable, higher-quality outputs
...
- [ ] XML structuring
- **[CORRECT]** One-shot or multi-shot prompting
...
- **[CORRECT]** To add structure and clarity, especially when including large amounts of content
...
#### Lesson 31: Introducing tool use

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287747](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287747)
...
#### Lesson 32: Project overview

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287751](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287751)
...
#### Lesson 33: Tool functions

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287756](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287756)
...
#### Lesson 34: Tool schemas

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287753](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287753)
...
#### Lesson 35: Handling message blocks

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287757](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287757)
...
#### Lesson 36: Sending tool results

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287752](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287752)
...
#### Lesson 37: Multi-turn conversations with tools

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287750](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287750)
...
#### Lesson 38: Implementing multiple turns

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287758](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287758)
...
#### Lesson 39: Using multiple tools

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287749](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287749)
...
#### Lesson 40: Fine grained tool calling

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/313160](https://anthropic.skilljar.com/claude-with-the-anthropic-api/313160)

**Video:** 011.1 - Fine Grained Tool Calling.mp4 | **Duration:** 10m 56s | **Platform:** jwplayer | **Captions:** English, French, German, Japanese, Korean, Portuguese, Spanish
...
#### Lesson 41: The text edit tool

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287760](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287760)
...
#### Lesson 42: The web search tool

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287755](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287755)
...
#### Lesson 43: Quiz on tool use with Claude

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/289122](https://anthropic.skilljar.com/claude-with-the-anthropic-api/289122)
...
- **[CORRECT]** Look at the stop_reason field for "tool_use"
- [ ] Count the number of message blocks

**Q2:** When Claude uses a tool, what type of message structure does it return?

- **[CORRECT]** Multi-block messages with text and tool use blocks
...
- **[CORRECT]** To tell Claude what arguments your function expects and how to use it
...
- **[CORRECT]** It reduces the number of back-and-forth communications when multiple tools are needed
- [ ] It automatically fixes errors in tool responses

**Q5:** What is the correct sequence of steps in the tool use workflow?

- **[CORRECT]** Initial Request > Tool Request > Data Retrieval > Final Response
...
- **[CORRECT]** Using tools to access external information

**Q7:** What makes Claude's built-in text editor and web search tools different from custom tools?

- **[CORRECT]** Claude provides the schema, but you may still need to implement some functionality
...
#### Lesson 44: Introducing Retrieval Augmented Generation

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287763](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287763)
...
#### Lesson 45: Text chunking strategies

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287776](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287776)
...
#### Lesson 46: Text embeddings

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287759](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287759)

**Video:** 07 - 003 - Text Embeddings.mp4 | **Duration:** 4m 2s | **Platform:** jwplayer | **Captions:** English, French, German, Japanese, Korean, Portuguese, Spanish
...
#### Lesson 47: The full RAG flow

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287764](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287764)
...
#### Lesson 48: Implementing the RAG flow

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287761](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287761)

**Video:** 07 - 005 - Implementing the Rag Flow.mp4 | **Duration:** 5m 12s | **Platform:** jwplayer | **Captions:** English, French, German, Japanese, Korean, Portuguese, Spanish
...
#### Lesson 49: BM25 lexical search

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287767](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287767)
...
#### Lesson 50: A Multi-Index RAG pipeline

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287766](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287766)
...
#### Lesson 51: Extended thinking

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287773](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287773)
...
#### Lesson 52: Image support

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287778](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287778)
...
#### Lesson 53: PDF support

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287768](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287768)
...
*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287771](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287771)
...
#### Lesson 55: Prompt caching

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287772](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287772)
...
#### Lesson 56: Rules of prompt caching

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287770](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287770)
...
#### Lesson 57: Prompt caching in action

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287774](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287774)
...
#### Lesson 58: Code execution and the Files API

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287777](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287777)

**Video:** 08 - 008 - Code Execution and the Files API.mp4 | **Duration:** 11m 7s | **Platform:** jwplayer | **Captions:** English, French, German, Japanese, Korean, Portuguese, Spanish
...
#### Lesson 59: Quiz on features of Claude

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/289124](https://anthropic.skilljar.com/claude-with-the-anthropic-api/289124)
...
- **[CORRECT]** Uploading files ahead of time and referencing them later instead of encoding them directly in messages
...
- **[CORRECT]** To create a clear trail from Claude's response back to specific parts of source documents
...
- **[CORRECT]** Reasoning process and final answer
...
- **[CORRECT]** Change the type to "document" and media_type to "application/pdf"
...
- **[CORRECT]** It has no network access and runs in an isolated Docker container
...
- **[CORRECT]** The content must be at least 1024 tokens long

---

### Model Context Protocol

#### Lesson 60: Introducing MCP

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287780](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287780)
...
#### Lesson 61: MCP clients

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287775](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287775)
...
*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287785](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287785)
...
#### Lesson 63: Defining tools with MCP

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287797](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287797)
...
#### Lesson 64: The server inspector

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287781](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287781)
...
#### Lesson 65: Implementing a client

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287793](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287793)
...
#### Lesson 66: Defining resources

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287782](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287782)
...
#### Lesson 67: Accessing resources

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287783](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287783)
...
#### Lesson 68: Defining prompts

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287784](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287784)
...
#### Lesson 69: Prompts in the client

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287786](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287786)
...
#### Lesson 70: MCP review

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287790](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287790)
...
#### Lesson 71: Quiz on Model Context Protocol

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/289126](https://anthropic.skilljar.com/claude-with-the-anthropic-api/289126)
...
- **[CORRECT]** Use the MCP Inspector in your browser
- [ ] Test in production
...
- [ ] Through a database
- [ ] Over the internet
- **[CORRECT]** Through standard input/output on the same machine
- [ ] Using email
...
- **[CORRECT]** MCP handles the tool definitions and execution for you
...
- **[CORRECT]** Use the @mcp.tool decorator on a function
...
#### Lesson 72: Anthropic apps

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287787](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287787)
...
#### Lesson 73: Claude Code setup

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287788](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287788)

**Video:** 10 - 002 - Claude Code Setup.mp4 | **Duration:** 1m 33s | **Platform:** jwplayer | **Captions:** English, French, German, Japanese, Korean, Portuguese, Spanish
...
Claude Code itself. Once installation is complete,

run the command Claude at your terminal. This will

prompt you to log in to your Anthropic account.

Now a full setup guide can be found at the official Anthropic

documentation at docs.anthropic.com.

Now I'm going to let you go through this setup process on your own, again,

just these three steps right here. As soon as you

are done, we're going to walk through a little project together

and see what Claude Code can really do for us.

---

#### Lesson 74: Claude Code in action

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287805](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287805)
...
#### Lesson 75: Enhancements with MCP servers

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287792](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287792)
...
#### Lesson 76: Agents and workflows

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287796](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287796)
...
#### Lesson 77: Parallelization workflows

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287804](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287804)
...
#### Lesson 78: Chaining workflows

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287800](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287800)
...
#### Lesson 79: Routing workflows

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287801](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287801)
...
#### Lesson 80: Agents and tools

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287803](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287803)
...
#### Lesson 81: Environment inspection

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287798](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287798)
...
#### Lesson 82: Workflows vs agents

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287794](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287794)
...
#### Lesson 83: Quiz on Agents and Workflows

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/289130](https://anthropic.skilljar.com/claude-with-the-anthropic-api/289130)
...
- **[CORRECT]** Provide abstract tools like "read_file", "write_file", and "run_command"
...
- [ ] Chaining workflow
- **[CORRECT]** Evaluator-Optimizer pattern
...
- **[CORRECT]** Route requests to specialized processing pipelines
...
- **[CORRECT]** Chain the task into focused sequential steps
...
- **[CORRECT]** Send separate requests for each material type in parallel
...
- **[CORRECT]** Use a workflow since it's more reliable and testable
...
- **[CORRECT]** A workflow with predetermined steps

---

### Final assessment

#### Lesson 84: Final Assessment

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/290899](https://anthropic.skilljar.com/claude-with-the-anthropic-api/290899)
...
- **[CORRECT]** A plain function that gets executed when Claude needs additional information or needs to perform an action
...
- **[CORRECT]** Use prompt evaluations to see if it actually improved
...
- **[CORRECT]** A system prompt explaining Claude should act like a tutor
...
- **[CORRECT]** "Write a product description for running shoes."
...
- **[CORRECT]** Prompt evaluation with automated testing

**Q7:** You're building a web app that talks to Claude. Where should you store your API key?

- **[CORRECT]** On your server, hidden from users
...
- **[CORRECT]** Another AI model used to assess the quality of outputs
...
- **[CORRECT]** Use XML tags like <reviews> and <sales_data> to separate them
...
- **[CORRECT]** To allow Claude to access real-time information and external systems beyond its training data
...
- **[CORRECT]** Feed the responses through a grader for scoring
...
- **[CORRECT]** You need to send the whole conversation history with each request
...
- **[CORRECT]** MCP Servers contain tools, prompts, and resources while MCP Clients act as the communication bridge to access those tools
...
- **[CORRECT]** A capability that lets Claude interact directly with desktop environments like a human would
...
- **[CORRECT]** MCP clients and servers can communicate using different methods like HTTP or standard input/output
...
- **[CORRECT]** To accept multiple tool calls and execute them simultaneously
...
- **[CORRECT]** A multi-block message with different content types
...
- **[CORRECT]** When you can picture the exact flow or steps Claude should go through to solve a problem
...
- **[CORRECT]** It allows agents to observe and understand the results of their actions
...
- **[CORRECT]** A communication layer that provides Claude with context and tools without requiring tedious integration code
...
- **[CORRECT]** Use prompt caching with cache breakpoints
...
#### Lesson 85: Course Wrap Up

*Source:* [https://anthropic.skilljar.com/claude-with-the-anthropic-api/287802](https://anthropic.skilljar.com/claude-with-the-anthropic-api/287802)
